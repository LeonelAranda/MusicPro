...
<div class="card p-4 bg-light">
    <form action="<?php print RUTA; ?>admonUsuarios/cambio/" method="POST">
        <div class="form-group text-left">
            ...
            <input type="email" name="correo" class="form-control" required placeholder="Escribe tu usuario(correo)" value="<?php print isset($datos['data']['correo']) ? $datos['data']['correo'] : ''; ?>">
        </div>

        <div class="form-group text-left">
            <label for="clave1">Contraseña:(si no deseas cambiar la contraseña deja en blanco)</label>
            <input type="password" name="clave1" class="form-control" placeholder="Escribe contraseña" value="">
        </div>

        <div class="form-group text-left">
            <label for="clave2">Repeticion de contraseña:</label>
            <input type="password" name="clave2" class="form-control" placeholder="Escribe contraseña" value="">
        </div>
        ...
        <div class="form-group">
            <label for="status">Selecciona un status del usuario</label>
