...
<div class="card p-4 bg-light">
  <form action="<?php print RUTA; ?>admonUsuarios/baja/" method="POST">
    <div class="form-group text-left">
      ...
      <input type="email" name="correo" class="form-control" disabled placeholder="Escribe tu usuario (tu correo electrónico)" value="<?php
    ...
    <div class="form-group text-left">
      ...
      <input type="text" name="nombre" class="form-control" placeholder="Escribe tu nombre" disabled value="<?php
    ...
    <div class="form-group text-left">
      <input type="hidden" id="id" name="id" value="<?php print $datos['data'][0]['id']; ?>" />
